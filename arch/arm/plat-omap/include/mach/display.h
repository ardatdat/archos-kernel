...
enum omap_rfbi_pix_dfm {
	OMAP_DSS_RFBI_DFM_STD = 0,
	OMAP_DSS_RFBI_DFM_RGB18_2 = 1,	// 6:6:6 in 2 cycles
	OMAP_DSS_RFBI_DFM_RGB18_3 = 2,	// 2x 6:6:6 in 3 cycles
};
...
enum omap_display_caps {
	...
	OMAP_DSS_DISPLAY_CAP_VIDEO_MODE = 1 << 1,
};
...
struct omap_dss_device {
	...
	union {
		...
		struct {
			u8 channel;
			u8 data_lines;
			enum omap_rfbi_pix_dfm pixel_dfm;
		} rfbi;
