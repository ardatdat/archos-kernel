...
static struct archos_fsusb_config fsusb_config __initdata = {
	...
	.rev[1] = {
		// fs usb not present on DVT devices.
		.suspend = { .nb = 27, .mux_cfg = AH7_3430_GPIO27 },
		.enable_usb_ohci = { .nb = 26, .mux_cfg = AG7_3430_GPIO26 },
	},
	.rev[2] = {
		.suspend = { .nb = 27, .mux_cfg = AH7_3430_GPIO27 },
		.enable_usb_ohci = UNUSED_GPIO,
...
#ifdef CONFIG_PM
struct vout_platform_data a70s_vout_data = {
...
MACHINE_START(ARCHOS_A70S, "Archos A70S board")
	.phys_io	= 0x48000000,
