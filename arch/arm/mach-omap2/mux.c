...
MUX_CFG_34XX("R8_34XX_GPIO56_OUT", 0x0b8,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("P8_34XX_GPIO57_OFF_LOW", 0x0ba,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("P8_34XX_GPIO57", 0xba, 
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_HIGH)
...
MUX_CFG_34XX("AA21_34XX_GPIO157_OUT", 0x18e,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("W1_34XX_GPIO49_OUT", 0x0a8,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
...
MUX_CFG_34XX("AB26_34XX_GPIO144", 0x174,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN)
...
MUX_CFG_34XX("M21_OMAP34XX_MCBSP2_DX", 0x142,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_INPUT_PULLDOWN)
...
MUX_CFG_34XX("A24_34XX_CAM_HS", 0x10C,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("A23_34XX_CAM_VS", 0x10E,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("C25_34XX_CAM_XCLKA", 0x110,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("C27_34XX_CAM_PCLK", 0x112,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("C23_34XX_CAM_FLD", 0x114,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("AG17_34XX_CAM_D0", 0x116,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
...
MUX_CFG_34XX("AE7_3430_GPIO24", 0x5f0,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT )
MUX_CFG_34XX("AF7_3430_GPIO25_OUT", 0x5f2,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)

MUX_CFG_34XX("V3_3430_GPT08", 0x1de,
		OMAP34XX_MUX_MODE1 )
...
MUX_CFG_34XX("AF9_3430_GPIO22", 0x5ec,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("B25_3430_GPIO109", 0x12A,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)

MUX_CFG_34XX("B26_3430_GPIO111", 0x12e,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("B26_3430_SAFE_UP", 0x12e, 
		OMAP34XX_MUX_MODE7 | OMAP2_PULL_ENA | OMAP2_PULL_UP)
MUX_CFG_34XX("B26_3430_SAFE_DOWN", 0x12e, 
		OMAP34XX_MUX_MODE7 | OMAP2_PULL_ENA)
		

MUX_CFG_34XX("AG18_3430_GPIO114_UP", 0x138,
		OMAP3_WAKEUP_EN |
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP)
...
MUX_CFG_34XX("K8_3430_GPIO64", 0x0D0,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("P26_3430_GPIO127", 0xa54,
		OMAP34XX_MUX_MODE4 )
...
MUX_CFG_34XX("Y2_3430_MCSPI2_SIMO", 0x1d8,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OFF_INPUT_PULLDOWN )
MUX_CFG_34XX("Y3_3430_MCSPI2_SOMI", 0x1da,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT_PULLDOWN ) 
MUX_CFG_34XX("Y4_3430_MCSPI2_CS0", 0x1dc,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OFF_INPUT_PULLDOWN )

MUX_CFG_34XX("C26_3430_GPIO110", 0x12C,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("R25_3430_GPIO129", 0xa5a,
		OMAP34XX_MUX_MODE4 )
MUX_CFG_34XX("R27_3430_GPIO128", 0xa58,
		OMAP34XX_MUX_MODE4 )
/* micro_sd_pwron */
MUX_CFG_34XX("V21_3430_GPIO158", 0x190,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN)
/* mmc1 prewarn */
MUX_CFG_34XX("N8_3430_GPIO58_IN", 0x0bc,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
...
MUX_CFG_34XX("H26_3630_DSS_DATA0", 0x100,
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("H25_3630_DSS_DATA1", 0x102, 
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("E28_3630_DSS_DATA2", 0x104,
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("J26_3630_DSS_DATA3", 0x106,
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AC27_3630_DSS_DATA4", 0x108, 
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AC28_3630_DSS_DATA5", 0x10a, 
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)

/* Alternative DSS_DATA0 - DSS_DATA5 in safe mode -> pins not used for A28 */
MUX_CFG_34XX("H26_3630_SAFE", 0x100,
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("H25_3630_SAFE", 0x102, 
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("E28_3630_SAFE", 0x104,
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("J26_3630_SAFE", 0x106,
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("AC27_3630_SAFE", 0x108, 
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("AC28_3630_SAFE", 0x10a, 
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN)

/* dss data lines on default pins */
MUX_CFG_34XX("AG22_3630_DSS_DATA0", 0xdc,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AH22_3630_DSS_DATA1", 0xde,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AG23_3630_DSS_DATA2", 0xe0,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AH23_3630_DSS_DATA3", 0xe2,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AG24_3630_DSS_DATA4", 0xe4,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AH24_3630_DSS_DATA5", 0xe6,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
		
/* DSS functions on default pins */
MUX_CFG_34XX("D26_3630_DSS_HSYNC", 0xd6,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("D27_3630_DSS_VSYNC", 0xd8,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("D28_3630_DSS_PCLK", 0xd4,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("E27_3630_DSS_ACBIAS", 0xda,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("E26_3630_DSS_DATA6", 0xe8,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("F28_3630_DSS_DATA7", 0xea,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("F27_3630_DSS_DATA8", 0xec,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("G26_3630_DSS_DATA9", 0xee,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AD28_3630_DSS_DATA10", 0xf0,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AD27_3630_DSS_DATA11", 0xf2,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AB28_3630_DSS_DATA12", 0xf4,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AB27_3630_DSS_DATA13", 0xf6,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AA28_3630_DSS_DATA14", 0xf8,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AA27_3630_DSS_DATA15", 0xfa,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("G25_3630_DSS_DATA16", 0xfc,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("H27_3630_DSS_DATA17", 0xfe,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
		
/* DSS functions on sysboot pins */
MUX_CFG_34XX("AH26_3630_DSS_DATA18", 0xa0a,
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AG26_3630_DSS_DATA19", 0xa0c,
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AF18_3630_DSS_DATA20", 0xa10,
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AF19_3630_DSS_DATA21", 0xa12,
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AE21_3630_DSS_DATA22", 0xa14,
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AF21_3630_DSS_DATA23", 0xa16,
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)

MUX_CFG_34XX("N8_3630_GPT08", 0x0bc,
		OMAP34XX_MUX_MODE3)
MUX_CFG_34XX("N8_3630_GPT08_OFF_HIGH", 0x0bc,
		OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OFF_OUTPUT_HIGH)
MUX_CFG_34XX("AD25_3630_GPT08", 0x17A,
		OMAP34XX_MUX_MODE2)
MUX_CFG_34XX("AF11_3630_GPIO14", 0x5dc,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)

MUX_CFG_34XX("AH14_3630_GPIO21", 0x5ea,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("T21_3630_GPIO160", 0x194,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("Y21_3630_GPIO156", 0x18c,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("AG12_3630_GPIO15", 0x5de,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("AH12_3630_GPIO16", 0x5e0,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)

/* Sys_clkout2 */
MUX_CFG_34XX("W13_3611_CLKOUT2", 0x1e2,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("AE22_3430_CLKOUT2", 0x1e2,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT)

/* USB to sata bridge */
MUX_CFG_34XX("N28_3630_GPIO120", 0x144,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("M27_3630_GPIO121", 0x146,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("N27_3630_GPIO122", 0x148,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("N26_3630_GPIO123", 0x14a,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("N25_3630_GPIO124", 0x14c,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("P28_3630_GPIO125", 0x14e,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)

/* Bluetooth digital audio interface */
MUX_CFG_34XX("AF6_OMAP34XX_MCBSP3_DX", 0x16c,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("AE6_OMAP34XX_MCBSP3_DR", 0x16e,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("AF5_OMAP34XX_MCBSP3_CLX", 0x170,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("AE5_OMAP34XX_MCBSP3_FSX", 0x172,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN)

/* HDMI digital audio interface */
MUX_CFG_34XX("AD2_OMAP34XX_MCBSP4_DX", 0x188,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("AD1_OMAP34XX_MCBSP4_DR", 0x186,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("AE1_OMAP34XX_MCBSP4_CLX", 0x184,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("AC1_OMAP34XX_MCBSP4_FSX", 0x18a,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN)


/* 3611 GPIO */
MUX_CFG_34XX("N20_3611_GPIO157", 0x18e,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("V1_3611_GPIO49", 0x0a8,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("D4_3611_GPT08", 0x1de,
		OMAP34XX_MUX_MODE1 )
MUX_CFG_34XX("P4_3611_GPIO24", 0x5f0,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("L2_3611_GPIO51", 0x0ac,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("J22_3611_GPIO111", 0x12e,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("W6_3611_GPIO27", 0x5f6,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("Y6_3611_GPIO28", 0x5f8,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("T4_3611_GPIO22", 0x5ec,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("H20_3611_GPIO96", 0x110,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("W16_3611_GPIO114", 0x138,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("U21_3611_GPIO156", 0x110,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("Y16_3611_GPIO115", 0x13a,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("K2_3611_GPIO50", 0x0aa,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("P3_3611_UART2_TX", 0x170,
		OMAP34XX_MUX_MODE1 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("R3_3611_UART2_RX", 0x172,
		OMAP34XX_MUX_MODE1 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_INPUT_PULLUP)
MUX_CFG_34XX("T1_3611_GPIO47", 0x0a4,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)

MUX_CFG_34XX("AA5_3611_GPIO25", 0x05f2,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("AB5_3611_GPIO26", 0x05f4,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)

MUX_CFG_34XX("U3_3611_MCBSP3_DX", 0x16c,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("T3_3611_MCBSP3_DR", 0x16e,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("P3_3611_MCBSP3_CLK", 0x170,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN)
MUX_CFG_34XX("R3_3611_MCBSP3_FSX", 0x172,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLDOWN)

MUX_CFG_34XX("AA25_3630_GPIO146", 0x178,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("AB25_3630_GPIO145", 0x176,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN)

MUX_CFG_34XX("AG8_3430_USB2FS_RCV", 0x5f8,
		OMAP34XX_MUX_MODE5 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("AH8_3430_USB2FS_VM", 0x5fa,
		OMAP34XX_MUX_MODE5 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("AB2_3430_USB2FS_VP", 0x1d4,
		OMAP34XX_MUX_MODE5 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("V3_3430_USB2FS_EN", 0x1de,
		OMAP34XX_MUX_MODE5 | OMAP34XX_PIN_INPUT)
		
MUX_CFG_34XX("H20_3430_UART3_RX_IRRX", 0x19e, 
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_INPUT_PULLUP)

MUX_CFG_34XX("K26_OMAP34XX_GPIO161_OFF_IPU", 0x196,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN | OMAP34XX_PIN_OFF_INPUT_PULLUP)
