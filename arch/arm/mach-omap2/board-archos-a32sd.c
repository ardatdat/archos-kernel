...
#ifdef CONFIG_PM
struct vout_platform_data a32sd_vout_data = {
...
{
	/* All A32SD boards have proper XO power supply */
...
MACHINE_START(ARCHOS_A32SD, "Archos A32SD board")
	.phys_io	= 0x48000000,
