...
void kill_block_super_hashWrapper(struct super_block *sb)
{
...
static struct file_system_type vfat_fs_type = {
	...
	.name = "vfat",
	.get_sb = vfat_get_sb,
	.kill_sb = kill_block_super_hashWrapper,
