...
struct fat_mount_options {
	...
	unsigned quiet:1,	/* set = fake successful chmods and chowns */
	 ...
	 computeFatHash:1;	/* do a Hash of the FAT */
};
...
extern void computeFatHash_setter(unsigned int storage, unsigned int hash);
