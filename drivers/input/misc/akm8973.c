/* drivers/input/misc/akm8973.c - akm8973 compass driver
 *
			   ...
			   char *buf)
{
	...
	AKI2C_RxData(&tmp,1);
        ...
        return sprintf(buf, "TMP : 0x%02X - X : 0x%02X - Y : 0x%02X - Z : 0x%02X\n", tmp, x, y, z);
}
...
static struct miscdevice akm_aot_device = {
	.minor = COMPASS_AOT_MINOR,
	.name = "akm8973_aot",
	.fops = &akm_aot_fops,
};

static struct miscdevice akmd_device = {
	.minor = COMPASS_DEV_MINOR,
	.name = "akm8973_dev",
	.fops = &akmd_fops,
};
...
{
	printk(KERN_INFO "AK8973 compass driver: suspend..\n");
	return 0;
}
...
static int __init akm8973_init(void)
{
	...
	if ((ret = i2c_add_driver(&akm8973_driver))) {
                printk(KERN_INFO "AK8973 compass driver: registration failed\n");
		return ret;
	}

        printk(KERN_INFO "AK8973 compass driver: registration done\n");
