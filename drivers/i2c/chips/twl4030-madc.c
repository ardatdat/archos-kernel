...
#else
	/* Code for TPS65921 */
	ret = twl4030_i2c_read_u8(TPS65921_MODULE_ACCESSORY_VINTDIG,
	&regval, TPS65921_BCIA_CTRL);

	regval |= TPS65921_BCIA_MESBAT;

	ret = twl4030_i2c_write_u8(TPS65921_MODULE_ACCESSORY_VINTDIG,
	regval, TPS65921_BCIA_CTRL);
#endif
