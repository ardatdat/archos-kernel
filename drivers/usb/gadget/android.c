...
static int __init android_bind(struct usb_composite_dev *cdev)
{
	...
	if (dev->bMaxPower)
		android_config_driver.bMaxPower = dev->bMaxPower;
	if (dev->bmAttributes)
		android_config_driver.bmAttributes = dev->bmAttributes;
...
static int __init android_probe(struct platform_device *pdev)
{
	...
	if (pdata) {
		...
		dev->bMaxPower = pdata->bMaxPower;
		dev->bmAttributes = pdata->bmAttributes;
	}
