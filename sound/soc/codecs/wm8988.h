...
extern void wm8988_power_up_inputs(struct snd_soc_codec *codec, int input_blocs, int on);
extern void wm8988_select_outputs(struct snd_soc_codec *codec, int outputs, int on);
